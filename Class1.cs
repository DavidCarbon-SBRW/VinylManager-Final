...
internal class Class1
{
	...
	public void method_0()
	{
		...
		if ((int)processesByName.Length != 0)
		{
			...
			this.intptr_0 = Class1.OpenProcess(2035711, false, this.process_0.Id);
	...
	public byte[] method_5(IntPtr intptr_1, uint uint_0)
	{
		unsafe
		{
			...
			else
			{
				try
				{
					Class1.VirtualProtectEx(this.intptr_0, intptr_1, (UIntPtr)uint_0, 4, out num);
					byte[] numArray1 = new byte[uint_0];
					Class1.ReadProcessMemory(this.intptr_0, intptr_1, numArray1, uint_0, 0);
					Class1.VirtualProtectEx(this.intptr_0, intptr_1, (UIntPtr)uint_0, num, out num);
					numArray = numArray1;
				}
				catch (Exception exception)
				{
	...
	public bool method_6(IntPtr intptr_1, byte[] byte_0)
	{
		...
		else
		{
			try
			{
				Class1.VirtualProtectEx(this.intptr_0, intptr_1, (UIntPtr)((long)((int)byte_0.Length)), 4, out num);
				bool flag1 = Class1.WriteProcessMemory(this.intptr_0, intptr_1, byte_0, (uint)byte_0.Length, 0);
				Class1.VirtualProtectEx(this.intptr_0, intptr_1, (UIntPtr)((long)((int)byte_0.Length)), num, out num);
				flag = flag1;
			}
			catch (Exception exception)
			{
